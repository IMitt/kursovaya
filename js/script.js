...
function handleButton(page) {
  switch (page) {
    case "mainPage":
      ...
      mainSection.style.display = "flex";
      localStorage.setItem("page", "mainPage");
      // Здесь можно добавить логику для перехода на главную страницу
      break;
    case "statusPage":
      ...
      statusSection.style.display = "flex";
      localStorage.setItem("page", "statusPage");
      // Здесь можно добавить логику для перехода на страницу статуса
      break;
    case "profilePage":
      console.log("Вы нажали на кнопку Профиль");
      localStorage.setItem("page", "profilePage");
      // Здесь можно добавить логику для перехода на страницу профиля
      break;
    default:
